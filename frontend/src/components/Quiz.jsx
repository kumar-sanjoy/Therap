...
const Quiz = () => {
    ...
    const checkAns = async (e, ans) => {
        ...
        if (question.answer === ans) {
            ...
            listItem.classList.add("bg-green-100", "border-green-500", "text-green-800");
            ...
            // Remove base background classes and add red styling
            listItem.classList.remove("bg-gray-50", "bg-gray-700", "hover:bg-gray-100", "hover:bg-gray-600");
            listItem.classList.add("bg-red-100", "border-red-500", "text-red-800");
    ...
    const handleNext = () => {
        ...
        // Reset all option styling - the useEffect will handle restoring proper styling
        options.forEach((option) => {
            if (option.current) {
                // Remove all answer styling
                    ...
                    <div className="p-8">
                        {showScore ? (
                            ...
                            <>
                                ...
                                <ul className="space-y-4 mb-6">
                                    {Object.entries(question.options).map(([key, value], i) => (
                                        <li
                                            ...
                                            className={`qz-option border rounded-lg px-6 py-4 text-lg cursor-pointer transition-all select-none ${
                                                isDarkMode 
                                ...
                                <button className={`px-6 py-3 font-medium rounded-lg transition-all hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed ${
                                    isDarkMode 
                                        ? 'bg-white hover:bg-gray-100 text-gray-900' 
                                        : 'bg-[#343434] hover:bg-gray-800 text-white'
                                }`} 
                                onClick={index === questions.length - 1 ? handleSubmitQuiz : handleNext} 
                                disabled={!lock}>
