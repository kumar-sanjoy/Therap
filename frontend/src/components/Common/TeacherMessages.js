// Shared teacher assistant messages for use across components
export const teacherMessages = {
  ...
  adviceUsed: [
    ...
    "Excellent! Advice helps you improve your approach! 💡",
    "Brilliant! You're taking steps to enhance your learning! 🌟",
    "Wonderful! Personalized advice is key to improvement! 🚀",
    "Amazing! You're actively working on your weaknesses! 💪",
  ...
  askingForAdvice: [
    "Would you like some advice on how to approach this type of question? 💡",
    "Should I give you some tips to avoid this mistake in the future? 🎯",
    "Would you like personalized advice to improve your performance? 🧠",
    "Let me know if you want some guidance on this topic! 🌟",
  ...
  prevMistake: [
    "💡 Tip: Review your previous mistakes carefully to understand where you went wrong.",
    "🎯 Tip: Focus on understanding the concept rather than just memorizing the answer.",
    "🧠 Tip: Take your time to analyze each question and think through your reasoning.",
    "📝 Tip: Practice similar questions to reinforce your understanding of the topic.",
    "🔍 Tip: Look for patterns in your mistakes to identify areas that need more attention.",
    "⚡ Tip: Don't rush through questions - accuracy is more important than speed.",
    "🎪 Tip: Use the hints and explanations to deepen your understanding.",
    "🌟 Tip: Every mistake is a learning opportunity - embrace the learning process.",
    "💪 Tip: Stay positive and keep practicing - improvement comes with persistence.",
    "🚀 Tip: Focus on the concepts you find challenging and practice them regularly."
  ]
};
...
// Utility function to get random message by type
export const getRandomMessageByType = (type) => {
  return getRandomMessage(teacherMessages[type] || teacherMessages.default);
};
